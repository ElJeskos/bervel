...
$questionTitles = [
    ...
    'C04.1' => 'Источники информации о тендерах',
    'C04.2' => 'Методы подключения',
    'C05' => 'Доступ к источнику',
    'C06' => 'Подходящий тендер',
    'C07' => 'Неподходящий тендер',
    'C08' => 'Обработка тендера',
    'C09' => 'Решение сотрудника',
    'C10' => 'Существующая база данных',
    'C11' => 'Подключение к базе данных',
    'C14' => 'Передача данных',
    'C15' => 'Передача результатов тендеров',
    'C17.1' => 'Методология расчётов',
    'C17.2' => 'Актуальные данные для расчётов',
    'C18' => 'Характеристики продукции',
    'C19' => 'Формат результата',
    'C20' => 'Бланки и оформление',
    'C21' => 'Рабочее место',
    'C24' => 'Объём и скорость',
    'C25' => 'Требования к серверу',
    'C26' => 'Выбор нейросети',
